...
app = FastAPI(
    title="Voice-Enabled RAG API (#RAGInGoa)",
    description="Sub-200ms Voice-Enabled RAG Pipeline with Engineered Chunking, Guardrails, Harness, & Latency Benchmarks.",
    version="1.0.0"
)
...
def health_check():
    return {
        "status": "online",
        "system": "Voice RAG Pipeline (#RAGInGoa)",
